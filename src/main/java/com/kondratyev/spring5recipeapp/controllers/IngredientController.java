...
import com.kondratyev.spring5recipeapp.services.IngredientService;
import com.kondratyev.spring5recipeapp.services.RecipeService;
import com.kondratyev.spring5recipeapp.services.UnitOfMeasureService;
...
public class IngredientController {
    ...
    @DeleteMapping // possibly not correct
    @RequestMapping("recipe/{recipeId}/ingredient/{id}/delete")
    public String deleteById(@PathVariable String recipeId,
                             @PathVariable String id){

        log.debug("Deleting Ingredient with id: " + id + " from recipe with id: " + recipeId);
