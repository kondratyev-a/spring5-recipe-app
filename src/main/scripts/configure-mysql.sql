...
CREATE USER 'recipe_dev_user'@'localhost' IDENTIFIED BY '123Qwe';
CREATE USER 'recipe_prod_user'@'localhost' IDENTIFIED BY '123Qwe';
CREATE USER 'recipe_dev_user'@'%' IDENTIFIED BY '123Qwe';
CREATE USER 'recipe_prod_user'@'%' IDENTIFIED BY '123Qwe';
